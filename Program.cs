    ...
    class Program
    {
        ...
        Tutorial:
...

            {
                ...
                Console.WriteLine("Welcome to Rec_rewild_2022!");
        ...
        Start:
            ...
            Console.WriteLine("(1) What's New" + Environment.NewLine +"(2) Change Settings" + Environment.NewLine + "(3) Modify Profile" + Environment.NewLine + "(4) Build Download Links" + Environment.NewLine + "(5) Start 2022/2023 Server");
