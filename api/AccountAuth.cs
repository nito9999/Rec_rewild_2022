...
namespace api
{
    internal class AccountAuth
    {
        ...
        {
            return JsonConvert.SerializeObject(new AccountMe
            {
                availableUsernameChanges = 1,
                email = "",
                birthday = new DateTime(1987, 9, 28, 4, 0, 0, DateTimeKind.Utc),
        ...
        public static string GetLevel2023Fix(string temp)
        {
        ...
        public class AccountMe
        {
            ...
            public bool isFakeJuniorBirthday { get; set; }
            public int accountId { get; set; }
            public string username { get; set; }
            public string displayName { get; set; }
            public string profileImage { get; set; }
